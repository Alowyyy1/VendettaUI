...
return function(Config)
	local Window = {
		...
		Topbar = Config.Topbar or { Height = 52, ButtonsType = "Mac" }, -- Default or Mac
	...
	if Window.Topbar == {} then
		Window.Topbar = { Height = 52, ButtonsType = "Mac" }
	end
	...
	Window:CreateTopbarButton("Minimize", "minus", function()
		...
		--     })
		-- end
	end, (Window.Topbar.ButtonsType == "Default" and 997 or 998), nil, Color3.fromHex("#FFBD2E"))
	...
	end, (Window.Topbar.ButtonsType == "Default" and 999 or 997), nil, Color3.fromHex("#FF5F56"))
